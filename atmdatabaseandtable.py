...
cursor.execute("""
    ...
    # Insert sample data
cursor.execute("INSERT IGNORE INTO admins (admin_id,username, password) VALUES ('1','Admin', 'Admin123')")
cursor.execute(
        "INSERT IGNORE INTO customers ( customer_id,name, email, phone, address) VALUES ('1000','Rohit Sharma', 'rohitsharma1@gmail.com', '9833224150', '264,Azad Nagar,Andheri West, Mumbai'),('1001','Vivek Sharma','viveksharma2@gmail.com','7712388082','63,Chandralok Colony,Khajrana,Indore'),('1002','Raj Karma','rajkarma3@gmail.com','8384532210','69,Ashok Nagar,Indore'),('1003','Ashish Joshi','ashishjoshi4@gmail.com','9844321120','422,Annapurna Road,Indore'),('1004','Amit Mishra','amitmishra@gmail.com','8822112300','21,Raj Nagar,Indore')")
